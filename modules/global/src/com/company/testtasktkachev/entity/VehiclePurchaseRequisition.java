...
@Table(name = "TESTTASKTKACHEV_VEHICLE_PURCHASE_REQUISITION")
@Entity(name = "testtasktkachev$VehiclePurchaseRequisition")
@Listeners("thesis_DocEntityListener")
@EnableRestore
@TrackEditScreenHistory
@PrimaryKeyJoinColumn(name = "CARD_ID", referencedColumnName = "ID")
public class VehiclePurchaseRequisition extends Doc implements HasDetailedDescription {

    private static final long serialVersionUID = -8327730035968235576L;
    ...
    @Column(name = "IS_PAY_CAR")
    protected Boolean isPayCar = false;
    ...
    public Boolean getIsPayCar() {
        return isPayCar;
    }

    public void setIsPayCar(Boolean isPayCar) {
