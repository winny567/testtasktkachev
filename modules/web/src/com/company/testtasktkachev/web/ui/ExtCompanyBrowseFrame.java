...
import com.haulmont.thesis.web.ui.company.CompanyBrowseFrame;

import javax.inject.Inject;

public class ExtCompanyBrowseFrame extends CompanyBrowseFrame {
    @Inject
    protected OrderService orderService;

    @Subscribe
    public void onInit(InitEvent event) {
        companiesTable.addGeneratedColumn("countRequisition",
